...
class _HomeBodyState extends State<_HomeBody> {
  ...
  Future<void> _loadData() async {
    final machines = await _machineService.searchMachines();
    final bookings = _bookingService.getRecentBookings();
    if (mounted) {
      setState(() {
        ...
        child: Column(
          ...
          children: [
            ...
            GridView.count(
              ...
              mainAxisSpacing: 12,
              children: [
                _CategoryCard(icon: Icons.construction, label: 'JCB', onTap: () => _searchCategory('JCB')),
                _CategoryCard(icon: Icons.precision_manufacturing, label: 'Excavator', onTap: () => _searchCategory('Excavator')),
                _CategoryCard(icon: Icons.engineering, label: 'Pokelane', onTap: () => _searchCategory('Pokelane')),
                _CategoryCard(icon: Icons.height, label: 'Crane', onTap: () => _searchCategory('Crane')),
                _CategoryCard(icon: Icons.agriculture, label: 'Bulldozer', onTap: () => _searchCategory('Bulldozer')),
                _CategoryCard(icon: Icons.roller_shades, label: 'Roller', onTap: () => _searchCategory('Roller')),
              ],
            ),
            const SizedBox(height: 24),
